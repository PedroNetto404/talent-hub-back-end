...
namespace TalentHub.Infra.Migrations
{
    ...
    [Migration("20241202125628_Company")]
            ...
            modelBuilder.Entity("TalentHub.ApplicationCore.Resources.Candidates.Candidate", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAtUtc")
                        ...
                        .HasDefaultValue(new DateTime(2024, 12, 2, 12, 56, 27, 746, DateTimeKind.Utc).AddTicks(3760))
                    ...
                    b.Property<DateTime>("UpdatedAtUtc")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2024, 12, 2, 12, 56, 27, 746, DateTimeKind.Utc).AddTicks(4115))
            ...
            modelBuilder.Entity("TalentHub.ApplicationCore.Resources.Companies.Company", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAtUtc")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2024, 12, 2, 12, 56, 27, 754, DateTimeKind.Utc).AddTicks(1843))
                        .HasColumnName("created_at_utc");
                    ...
                    b.Property<DateTime>("UpdatedAtUtc")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2024, 12, 2, 12, 56, 27, 754, DateTimeKind.Utc).AddTicks(2191))
                        .HasColumnName("updated_at_utc");
            ...
            modelBuilder.Entity("TalentHub.ApplicationCore.Resources.Users.User", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAtUtc")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2024, 12, 2, 12, 56, 27, 771, DateTimeKind.Utc).AddTicks(8463))
                        .HasColumnName("created_at_utc");
                    ...
                    b.Property<DateTime>("UpdatedAtUtc")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2024, 12, 2, 12, 56, 27, 771, DateTimeKind.Utc).AddTicks(8791))
                        .HasColumnName("updated_at_utc");

            ...
            modelBuilder.Entity("TalentHub.ApplicationCore.Resources.Candidates.Candidate", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAtUtc")
                        ...
                        .HasDefaultValue(new DateTime(2024, 12, 3, 22, 24, 26, 656, DateTimeKind.Utc).AddTicks(907))
                    ...
                    b.Property<DateTime>("UpdatedAtUtc")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2024, 12, 3, 22, 24, 26, 656, DateTimeKind.Utc).AddTicks(1457))
            ...
            modelBuilder.Entity("TalentHub.ApplicationCore.Resources.Companies.Company", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAtUtc")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2024, 12, 3, 22, 24, 26, 672, DateTimeKind.Utc).AddTicks(3936))
                        .HasColumnName("created_at_utc");
                    ...
                    b.Property<DateTime>("UpdatedAtUtc")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2024, 12, 3, 22, 24, 26, 672, DateTimeKind.Utc).AddTicks(4463))
                        .HasColumnName("updated_at_utc");
            ...
            modelBuilder.Entity("TalentHub.ApplicationCore.Resources.Users.User", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAtUtc")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2024, 12, 3, 22, 24, 26, 710, DateTimeKind.Utc).AddTicks(5660))
                        .HasColumnName("created_at_utc");
                    ...
                    b.Property<DateTime>("UpdatedAtUtc")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2024, 12, 3, 22, 24, 26, 710, DateTimeKind.Utc).AddTicks(6413))
                        .HasColumnName("updated_at_utc");

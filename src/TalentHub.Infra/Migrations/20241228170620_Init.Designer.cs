...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TalentHub.ApplicationCore.Resources.Candidates.Candidate", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAtUtc")
                        ...
                        .HasDefaultValue(new DateTime(2024, 12, 28, 17, 6, 19, 395, DateTimeKind.Utc).AddTicks(6991))
                    ...
                    b.Property<DateTime>("UpdatedAtUtc")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2024, 12, 28, 17, 6, 19, 395, DateTimeKind.Utc).AddTicks(7676))
                    ...
                    b.Property<IEnumerable<string>>("_desiredJobTypes")
                        .IsRequired()
                        .HasColumnType("text[]")
                        .HasColumnName("desired_job_types");

                    b.Property<IEnumerable<string>>("_desiredWorkplaceTypes")
                        .IsRequired()
                        .HasColumnType("text[]")
            ...
            modelBuilder.Entity("TalentHub.ApplicationCore.Resources.Candidates.SubResources.Certificates.Certificate", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("TalentHub.ApplicationCore.Resources.Candidates.SubResources.Certificates.UseCases.Commands.Experience", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("TalentHub.ApplicationCore.Resources.Candidates.SubResources.Languages.LanguageProficiency", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("TalentHub.ApplicationCore.Resources.Candidates.SubResources.Skills.CandidateSkill", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("TalentHub.ApplicationCore.Resources.Companies.Company", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAtUtc")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2024, 12, 28, 17, 6, 19, 432, DateTimeKind.Utc).AddTicks(4711))
                        .HasColumnName("created_at_utc");
                    ...
                    b.Property<DateTime>("UpdatedAtUtc")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2024, 12, 28, 17, 6, 19, 432, DateTimeKind.Utc).AddTicks(5247))
                        .HasColumnName("updated_at_utc");
            ...
            modelBuilder.Entity("TalentHub.ApplicationCore.Resources.Users.User", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAtUtc")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2024, 12, 28, 17, 6, 19, 456, DateTimeKind.Utc).AddTicks(2504))
                        .HasColumnName("created_at_utc");
                    ...
                    b.Property<DateTime>("UpdatedAtUtc")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2024, 12, 28, 17, 6, 19, 456, DateTimeKind.Utc).AddTicks(3306))
                        .HasColumnName("updated_at_utc");
            ...
            modelBuilder.Entity("TalentHub.ApplicationCore.Resources.Candidates.SubResources.Experiences.AcademicExperience", b =>
                {
                    b.HasBaseType("TalentHub.ApplicationCore.Resources.Candidates.SubResources.Certificates.UseCases.Commands.Experience");
                    ...
                    b.HasIndex("CourseId")
                        .HasDatabaseName("ix_academic_experiences_course_id");

                    b.HasIndex("UniversityId")
                        .HasDatabaseName("ix_academic_experiences_university_id");

                    b.ToTable("academic_experiences", (string)null);
                });

            modelBuilder.Entity("TalentHub.ApplicationCore.Resources.Candidates.SubResources.Experiences.ProfessionalExperience", b =>
                {
                    b.HasBaseType("TalentHub.ApplicationCore.Resources.Candidates.SubResources.Certificates.UseCases.Commands.Experience");
            ...
            modelBuilder.Entity("TalentHub.ApplicationCore.Resources.Candidates.SubResources.Languages.LanguageProficiency", b =>
                {
                    b.HasOne("TalentHub.ApplicationCore.Resources.Candidates.Candidate", null)
                        ...
                        .HasForeignKey("candidate_id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .HasConstraintName("fk_language_proficiencies_candidates_candidate_id");
                });
            ...
            modelBuilder.Entity("TalentHub.ApplicationCore.Resources.Candidates.SubResources.Experiences.AcademicExperience", b =>
                {
                    b.HasOne("TalentHub.ApplicationCore.Resources.Courses.Course", null)
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_academic_experiences_course_course_id");

                    b.HasOne("TalentHub.ApplicationCore.Resources.Candidates.SubResources.Certificates.UseCases.Commands.Experience", null)
                        .WithOne()
                        .HasForeignKey("TalentHub.ApplicationCore.Resources.Candidates.SubResources.Experiences.AcademicExperience", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_academic_experiences_experiences_id");
                    ...
                    b.HasOne("TalentHub.ApplicationCore.Resources.Universities.University", null)
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_academic_experiences_university_university_id");
                    ...
                    b.OwnsOne("TalentHub.ApplicationCore.Shared.ValueObjects.DatePeriod", "ExpectedGraduation", b1 =>
                        {
                            ...
                            b1.ToTable("academic_experiences");

                            b1.WithOwner()
                                .HasForeignKey("AcademicExperienceId")
                                .HasConstraintName("fk_academic_experiences_academic_experiences_id");
                        });
            ...
            modelBuilder.Entity("TalentHub.ApplicationCore.Resources.Candidates.SubResources.Experiences.ProfessionalExperience", b =>
                {
                    b.HasOne("TalentHub.ApplicationCore.Resources.Candidates.SubResources.Certificates.UseCases.Commands.Experience", null)
                        .WithOne()
                        .HasForeignKey("TalentHub.ApplicationCore.Resources.Candidates.SubResources.Experiences.ProfessionalExperience", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_professional_experiences_experiences_id");
                });
